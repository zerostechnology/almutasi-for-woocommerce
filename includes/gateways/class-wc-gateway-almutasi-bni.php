...
class WC_Gateway_Almutasi_BNI extends Almutasi_Gateway
{
    public $sub_id = 'almutasi_woocommerce_bni';
    
    public function __construct()
    {
        parent::__construct();

        $this->method_title = "alMutasi - Bank BNI";
        $this->method_description = "Pembayaran divalidasi otomatis berdasarkan nominal unik";
        $this->payment_method = "bni";
